...
class PaypalController extends Controller
{
    ...
    public function getCheckout()
    {
        ...
        $clientId = env('ASvvNFxvL_6Iprqr5Dwd-zqaCWLgZf8Kc-t5W7i6eS6Q9bmfgtSDpPN2uMiZ7fSy-qGUX1LbYMUWadyE');
        $clientSecret = env('EABWKXQhBkIq8lhEiVlWJgJbSVwqKEWf7RSyw6ixO4nsOS7_9VthOwmHbg8dV3so8meVjNOjkEnqKzqb');
