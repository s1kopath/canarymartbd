    ...
    <div class="container">
        ...
        <div class="row no-gutters">
            <div class="col-md-6 col-sm-12">
                ...
                <a class="text-reset d-block" href="{{ route('terms') }}">
                    <!--<i class="la la-file-text la-3x text-primary mb-2"></i>
                    <h4 class="h6" style="color:#fff !important;">{{ translate('Terms & conditions') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-3">
                <a class="text-reset d-block" href="{{ route('returnpolicy') }}">
                    <!--<i class="la la-mail-reply la-3x text-primary mb-2"></i>
                    <h4 class="h6" style="color:#fff !important;">{{ translate('Return Policy') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-3">
                <a class="text-reset d-block" href="{{ route('supportpolicy') }}">
                    <!--<i class="la la-support la-3x text-primary mb-2"></i>
                    <h4 class="h6" style="color:#fff !important;">{{ translate('Support Policy') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-3">
                <a class="text-reset  d-block" href="{{ route('privacypolicy') }}">
                    <!--<i class="las la-exclamation-circle la-3x text-primary mb-2"></i>
                    <h4 class="h6" style="color:#fff !important;">{{ translate('Privacy Policy') }}</h4>
                </a>
            </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row no-gutters">
            <div class="col-lg-7 col-xl-7 col-md-7 col-sm-12">
                ...
                <a class="text-reset d-block" href="{{ route('terms') }}">
                    <!--<i class="la la-file-text la-3x text-primary mb-2"></i>-->
                    <h4 class="h6" style="color:#fff !important; font-size:14px;">{{ translate('Terms & conditions') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-3">
                <a class="text-reset d-block" href="{{ route('returnpolicy') }}">
                    <!--<i class="la la-mail-reply la-3x text-primary mb-2"></i>-->
                    <h4 class="h6" style="color:#fff !important; font-size:14px;">{{ translate('Return Policy') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-3">
                <a class="text-reset d-block" href="{{ route('supportpolicy') }}">
                    <!--<i class="la la-support la-3x text-primary mb-2"></i>-->
                    <h4 class="h6" style="color:#fff !important; font-size:14px;">{{ translate('Support Policy') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-3">
                <a class="text-reset  d-block" href="{{ route('privacypolicy') }}">
                    <!--<i class="las la-exclamation-circle la-3x text-primary mb-2"></i>-->
                    <h4 class="h6" style="color:#fff !important; font-size:14px;">{{ translate('Privacy Policy') }}</h4>
                </a>
            </div>
                </div>
            </div>
